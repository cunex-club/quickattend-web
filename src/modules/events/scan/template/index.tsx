...
const ScanTemplate = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-200 p-6 md:p-8">
      <div className="grid min-h-[calc(100vh-3rem)] w-full grid-cols-1 gap-6 md:min-h-[calc(100vh-4rem)] lg:grid-cols-2">
        <section className="flex min-h-[720px] flex-col items-center justify-center rounded-[32px] p-8 lg:h-full lg:min-h-0">
            ...
            <div className="flex flex-col items-center">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    type="button"
                    className="inline-flex items-center gap-1 text-neutral-600 rounded focus:outline-none focus:ring-2 focus:ring-primary/50"
        ...
        <section className="h-full min-h-[720px] rounded-[32px] bg-white px-8 py-10 md:px-14 md:py-14 flex flex-col justify-center lg:min-h-0">
          <div className="flex w-full items-center justify-between gap-4">
            ...
            <p className="shrink-0 whitespace-nowrap text-center">
              ...
              <span className="display-small-emphasized text-neutral-600 text-primary">
                คน
              </span>
            </p>
          </div>
